...
open(`https://accounts.spotify.com/authorize?client_id=${configuration["SPOTIFY_CLIENT_ID"]}&response_type=code&redirect_uri=https%3A%2F%2Flocalhost%3A${SERVER_PORT}%2Fcallback&scope=user-read-playback-state%20user-read-currently-playing`)
